...
No masks were fabricated — all values below come directly from the captured events.
...
- Attackers can dump LSASS without opening a classic handle — e.g. via a driver,
